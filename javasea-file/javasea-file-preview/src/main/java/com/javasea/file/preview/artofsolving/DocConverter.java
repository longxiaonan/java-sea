...
public class DocConverter {
    ...
    private static final String EXEC_COMMAND = "D:/soft/swf/pdf2swf.exe -o %s -s flashversion=9 %s";

    private static final String openOfficeHost = "192.168.1.234";
    private static final Integer openOfficePort = 8100;
...
//                      Process p = r.exec("D:/Program Files/SWFTools/pdf2swf.exe "+ pdfFile.getPath() + " -o "+ swfFile.getPath() + " -T 9");
                        Process pro = Runtime.getRuntime().exec(String.format(EXEC_COMMAND, pdfFile.getPath(), swfFile.getPath()));
