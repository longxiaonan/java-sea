...
public class DataVAreaDataUtil {
    ...
    private DataVAreaDataUtil() {
    }

    private static class SingletonFactory {
        private static DataVAreaDataUtil instance = new DataVAreaDataUtil();
    }

    public static DataVAreaDataUtil getInstance() {
        //加载中国省份的区域code和省份名称.
    ...
    public static void main(String[] args) {
        System.out.println(DataVAreaDataUtil.getInstance().getAreaData());//默认是获取全国省(包括直辖市)的区域id和行政名
        System.out.println(DataVAreaDataUtil.getInstance().getAreaData("110000"));//110000为北京市的区域id
        System.out.println(DataVAreaDataUtil.getInstance().getAreaData("440000"));//440000为广东省的区域id
        System.out.println(DataVAreaDataUtil.getInstance().getAreaData("441900"));//441900为东莞的区域id
    }
}
