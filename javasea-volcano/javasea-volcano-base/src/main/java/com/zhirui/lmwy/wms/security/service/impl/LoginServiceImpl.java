...
package com.zhirui.lmwy.wms.security.service.impl;

import com.alibaba.fastjson.JSON;
import com.zhirui.lmwy.common.persistence.constant.CommonConstant;
import com.zhirui.lmwy.common.persistence.constant.CommonRedisKey;
import com.zhirui.lmwy.common.persistence.model.result.ResultModel;
import com.zhirui.lmwy.common.redis.RedisUtils;
import com.zhirui.lmwy.common.utils.MapUtil;
import com.zhirui.lmwy.common.utils.web.ClientInfoUtil;
...
import com.zhirui.lmwy.wms.security.vo.JwtTokenRedisVo;
import com.zhirui.lmwy.wms.security.vo.LoginSysUserRedisVo;
import com.zhirui.lmwy.wms.security.vo.LoginSysUserVo;
...
public class LoginServiceImpl implements LoginService {
    ...
    @Override
    public ResultModel login(LoginParam loginParam) {
...
//        redisTemplate.opsForHash().put(loginTokenRedisKey,tokenMd5,loginSysUserRedisVo);
        redisUtils.hset(loginTokenRedisKey,tokenMd5,loginSysUserRedisVo,30*60);
...
//        redisTemplate.opsForHash().put(loginUserRedisKey,tokenMd5,jwtTokenRedisVo);
        redisUtils.hset(loginUserRedisKey,tokenMd5,jwtTokenRedisVo,30*60);
