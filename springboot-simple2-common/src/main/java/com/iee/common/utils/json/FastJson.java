package com.iee.common.utils.json;
...
import com.iee.common.utils.JacksonUtils;
...
//        add2Json();
    ...
    private static void conversionType() {
        ...
        User student = JSONObject.parseObject(jsonObject.toJSONString(), new TypeReference<User>() {});
        System.out.println(student);
        //第二种方式,使用Gson的思想
        User student1 = JSONObject.parseObject(jsonObject.toJSONString(), User.class);
...
//        JacksonUtils.map2pojo(map2pojo)
        ...
        //8. array to list
        List<User> users = JSONArray.parseArray(usersString, User.class);
