...
import com.zhirui.lmwy.mgr.web.controller.BaseController;
...
import com.zhirui.lmwy.mgr.web.param.IdParam;
...
public class SysLogController extends BaseController {
    ...
    */
    ...
    public ResultModel<Paging<SysLogQueryVo>> getSysLogPageList(@Valid @RequestBody(required = false) SysLogQueryParam sysLogQueryParam) throws Exception{
